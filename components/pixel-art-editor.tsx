...
export default function PixelArtEditor() {
  ...
  return (
    <SidebarProvider defaultOpen={true}>
      <div className="flex h-screen w-full bg-pixel-editor-bg text-pixel-editor-text font-sans selection:bg-orange-500/30">
        
        <Sidebar side="left" collapsible="icon" className="bg-pixel-editor-sidebar border-pixel-editor-border">
          <SidebarHeader className="p-4">
            <div className="flex items-center gap-3 px-2 group-data-[collapsible=icon]:px-0 group-data-[collapsible=icon]:justify-center">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center shadow-lg shadow-orange-900/20 flex-shrink-0">
        ...
        <SidebarInset className="flex-1 flex flex-col relative bg-pixel-editor-bg overflow-hidden">
  
        <div className="h-16 flex items-center justify-between px-6 border-b border-pixel-editor-border bg-pixel-editor-bg/80 backdrop-blur-sm z-10">
          <div className="flex items-center gap-2">
            <SidebarTrigger className="text-zinc-400 hover:text-white" />
            <div className="flex items-center gap-2 bg-pixel-editor-panel p-1 rounded-lg border border-pixel-editor-border">
              <button
                onClick={undo}
          ...
          <div className="flex items-center gap-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 bg-pixel-editor-panel px-3 py-2 rounded-lg border border-pixel-editor-border hover:bg-white/5 transition-colors">
                  <span className="text-xs font-medium text-zinc-400">Grid</span>
                  <span className="text-sm text-white font-medium">{gridSize}x{gridSize}</span>
                  <ChevronDown size={14} className="text-zinc-400" />
                </button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="bg-pixel-editor-panel border-pixel-editor-border">
                <DropdownMenuItem 
            ...
            <button
              ...
              className={cn(
                ...
                showGridLines
                  ...
                  : "bg-pixel-editor-panel hover:bg-white/5",
              )}
            >
              <Grid3X3 size={18} />
            </button>
        ...
        >
          ...
          <div className="fixed bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-pixel-editor-panel/90 backdrop-blur-md p-2 rounded-2xl border border-pixel-editor-border shadow-2xl z-50">
            {[
      ...
      <Sidebar side="right" collapsible="icon" className="bg-pixel-editor-sidebar border-pixel-editor-border">
        <SidebarHeader className="p-6 border-b border-pixel-editor-border">
          <div className="group-data-[collapsible=icon]:hidden">
        ...
        <SidebarContent className="p-6 space-y-8">
          <div className="space-y-3">
            <label className="text-xs font-medium text-zinc-400 uppercase tracking-wider group-data-[collapsible=icon]:hidden">Color</label>
            <div className="grid grid-cols-6 gap-2 group-data-[collapsible=icon]:grid-cols-1 group-data-[collapsible=icon]:place-items-center group-data-[collapsible=icon]:px-2">
              {COLORS.map((color) => (
                <button
                  key={color}
                  ...
                  className={cn(
                    ...
                    selectedColor === color
                      ...
                      : color === "#ffffff"
                      ? "dark:border-transparent border-zinc-300 hover:border-zinc-400"
          ...
          <div className="space-y-3 group-data-[collapsible=icon]:hidden">
            ...
            <div className="bg-pixel-editor-panel p-4 rounded-xl border border-pixel-editor-border">
